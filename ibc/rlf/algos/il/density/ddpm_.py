...
if __name__ == '__main__':
    ...
    #print("test:", args.traj_load_path.split('/')[-1].split('.')[0])
    #print("data:", data)
    obs = data['obs'].to(device)
    actions = data['actions'].to(device)
    #print("type(obs)", obs.size()) #[18525, 6]
    #print("type(actions):", actions.size()) #[18525, 2]
    ...
    torch.save(model.state_dict(), os.path.join(ddpm_model, env + '_ddpm.pt'))
